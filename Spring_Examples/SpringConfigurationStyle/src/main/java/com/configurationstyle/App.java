...
public class App {
    ...
    public static void main(String[] args) {
        ...
        AnnotationConfigApplicationContext context =
                new AnnotationConfigApplicationContext(AnnotationBasedConfig.class);

        // ask the container or spring to get the delegate bean or object

        System.out.println("***********Annotation Based Configuration***********");

        DelegateAnnotationBased delegate =
                context.getBean(DelegateAnnotationBased.class);
        ...
        DelegateXmlBased delegate1 =
                context1.getBean("delegate", DelegateXmlBased.class);
        ...
        DelegateJavaBasedConfig delegate2 =
                context2.getBean("delegate", DelegateJavaBasedConfig.class);
